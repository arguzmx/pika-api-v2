...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pika.modelo.contenido.Carpeta.Carpeta", b =>
                {
                    ...
                    b.ToTable("contenido$carpeta", (string)null);
                });

            modelBuilder.Entity("pika.modelo.contenido.Contenido.Contenido", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("varchar(128)");
            ...
            modelBuilder.Entity("pika.modelo.contenido.Repositorio.Repositorio", b =>
                {
                    ...
                    b.ToTable("contenido$repositorio", (string)null);
                });

            modelBuilder.Entity("pika.modelo.contenido.Volumen.Volumen", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("varchar(128)");
            ...
            modelBuilder.Entity("pika.modelo.contenido.Contenido.Contenido", b =>
                {
                    b.HasOne("pika.modelo.contenido.Carpeta.Carpeta", "Carpeta")
                        .WithMany("Contenido")
                    ...
                    b.HasOne("pika.modelo.contenido.Volumen.Volumen", "Volumen")
                        .WithMany("Contenido")
