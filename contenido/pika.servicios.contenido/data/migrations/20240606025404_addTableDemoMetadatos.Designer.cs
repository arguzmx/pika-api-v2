...
namespace pika.servicios.contenido.data.migrations
{
    ...
    [Migration("20240606025404_addTableDemoMetadatos")]
    partial class addTableDemoMetadatos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pika.modelo.contenido.demometadatos.DemoMetadatos", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("varchar(128)");
                    ...
                    b.Property<DateOnly>("HoraDeLunch")
                        .HasColumnType("date");
                    ...
                    b.ToTable("cont$demometadatos", (string)null);
                });
