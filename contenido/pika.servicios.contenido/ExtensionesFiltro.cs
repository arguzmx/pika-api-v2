...
public static class ExtensionesFiltro
{
    ...
    public static Dictionary<string, TipoDato> TipoDatoCFDI
    {
        get
        {
            return new()
            {
                ...
                { "TipoGestorESId",      TipoDato.Texto},
                { "TamanoMaximo",          TipoDato.Numero},
                { "Activo",               TipoDato.Booleano},
                { "EscrituraHabilitada",               TipoDato.Booleano},
                { "Tamano",               TipoDato.Numero},
    ...
    public static string PaginarConsulta(this PaginaGenerica<object> pagina, Consulta consulta)
    {
