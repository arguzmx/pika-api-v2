...
namespace pika.servicios.gestiondocumental.data.migrations
{
    ...
    [Migration("20240522193045_addRelArchivo")]
    partial class addRelArchivo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("pika.modelo.gestiondocumental.Activo", b =>
                {
                    ...
                    b.HasIndex("TipoArchivoActualId");
            ...
            modelBuilder.Entity("pika.modelo.gestiondocumental.Activo", b =>
                {
                    b.HasOne("pika.modelo.gestiondocumental.Archivo", "ArchivoActual")
                        ...
                        .HasForeignKey("pika.modelo.gestiondocumental.Activo", "ArchivoActualId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("pika.modelo.gestiondocumental.Archivo", "ArchivoOrigen")
                        .WithOne("ActivoOrigen")
                        .HasForeignKey("pika.modelo.gestiondocumental.Activo", "ArchivoOrigenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("pika.modelo.gestiondocumental.TipoArchivo", "TipoArchivoActual")
                        .WithMany()
                        .HasForeignKey("TipoArchivoActualId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("pika.modelo.gestiondocumental.UnidadesAdministrativas.UnidadAdministrativa", "UnidadAdministrativa")
                        .WithMany()
                    ...
                    b.Navigation("TipoArchivoActual");
