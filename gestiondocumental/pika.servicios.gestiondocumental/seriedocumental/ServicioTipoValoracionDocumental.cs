...
{
    [ServicioCatalogoEntidadAPI(typeof(TipoValoracionDocumental))]
    public class ServicioTipoValoracionDocumental : ServicioCatalogoGenericoBase, IServicioCatalogoAPI,IServicioTipoDisposicionDocumental
    {
        public ServicioTipoValoracionDocumental(ILogger<ServicioTipoValoracionDocumental> logger, DbContextGestionDocumental context) : base(context, context.TipoValoracionDocumental, logger)
        {
        }
